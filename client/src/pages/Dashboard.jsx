  ...
  return (
    <div className="container mt-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl md:text-4xl font-bold">Welcome{user ? `,` : ''} <span className="text-blue-600">{user ? 'Community Member' : ''}</span></h1>
          <p className="text-slate-600 mt-2">Overview of recent activity and community metrics.</p>
        </div>
